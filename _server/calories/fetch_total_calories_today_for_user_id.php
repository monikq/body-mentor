...
{ 
	...
	$query = "SELECT SUM(`weight`) AS 'total_grams_today', SUM(CAST(`kCal_100g`/100*`weight` AS INT)) AS 'total_kcal_today' FROM `daily_calories` WHERE `DT` = CURRENT_DATE AND `user_id` = $user_id";
